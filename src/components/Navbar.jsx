    ...
    return (
        <>
            ...
            <nav ref={navRef} className="w-full fixed px-5 lg:px-8 xl:px-[8%] py-4 flex items-center justify-between z-50">
                ...
                <a href="#top">
                    <h1 className="text-2xl font-bold font-Ovo">
                        Bharathi<span className="text-purple-500">.</span>
                    </h1>
                </a>
                ...
                <ul ref={navLinkRef} className="hidden md:flex items-center gap-6 lg:gap-8 rounded-full px-12 py-3 bg-white shadow-sm bg-opacity-50 font-Ovo dark:border dark:border-white/30 dark:bg-transparent">
                    <li><a className='hover:text-gray-500 dark:hover:text-gray-300' href="#top">Home</a></li>
                    <li><a className='hover:text-gray-500 dark:hover:text-gray-300' href="#about">About me</a></li>
                    <li><a className='hover:text-gray-500 dark:hover:text-gray-300' href="#services">Services</a></li>
                    <li><a className='hover:text-gray-500 dark:hover:text-gray-300' href="#work">My Work</a></li>
                    <li><a className='hover:text-gray-500 dark:hover:text-gray-300' href="#contact">Contact me</a></li>
                </ul>
