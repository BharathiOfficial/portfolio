export default function Work() {
    ...
    const work = [
        {
            name: 'Banana Farming Website',
            icon: './assets/work-1.png',
            description: 'Web Development Project',
            link: '',
        },
        {
            name: 'CSE Department InfoBot',
            icon: './assets/work-2.png',
            description: 'Chatbot using Flask & Dialogflow',
            link: '',
        },
        {
            name: 'Notebook LLM Project',
        ...
        },
        {
            ...
            description: 'AI-based Health Analysis System',
            link: '',
        }
    ];
    ...
    return (
        <div id="work" className="w-full px-[12%] py-10 scroll-mt-20">
            ...
            <p className="text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo">
                Here are some of the projects I have developed in Web Development, Machine Learning and AI.
            </p>
